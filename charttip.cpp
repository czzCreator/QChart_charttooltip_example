...
ChartTip::ChartTip(QChart *chart):
    QGraphicsItem(chart),
    m_chart(chart)
{
}
...
void ChartTip::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    QPainterPath path;
...
void ChartTip::setText(const QString &text)
{
    m_text = text;
